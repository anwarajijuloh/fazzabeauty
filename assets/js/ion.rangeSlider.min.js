// Ion.RangeSlider, 2.3.0, Â© Denis Ineshin, 2010 - 2018, IonDen.com, Build
// date: 2018-12-11 23:11:14
!function (i) {
    ...
    var i,
        ...
        e = (
            i = t.userAgent,
            s = /msie\s\d+/i,
            0 < i.search(s) && s.exec(i).toString().split(" ")[1] < 9 && (
    ...
    var h = function (t, i, s) {
        ...
        n !== _ && "" !== n && (
            (n = n.split(e.input_values_separator || i.input_values_separator || ";"))[0] && n[0] ==+ n[0] && (
                n[0] = +n[0]
            ),
            n[1] && n[1] ==+ n[1] && (n[1] = +n[1]),
    ...
    h.prototype = {
        ...
        append: function () {
            var t = '<span class="irs irs--' + this.options.skin + " js-irs-" + this.plugin_count +
            ...
            this
                ...
                .cont
                .html(
                    '<span class="irs"><span class="irs-line" tabindex="0"></span><span class="irs-' +
                    'min">0</span><span class="irs-max">1</span><span class="irs-from">0</span><spa' +
                    'n class="irs-to">0</span><span class="irs-single">0</span></span><span class="' +
                    'irs-grid"></span>'
                ),
            this.$cache.rs = this
                .$cache
            ...
            "single" === this.options.type
                ? (
                    this.$cache.cont.append(
                        '<span class="irs-bar irs-bar--single"></span><span class="irs-shadow shadow-si' +
                        'ngle"></span><span class="irs-handle single"><i></i><i></i><i></i></span>'
                    ),
                ...
                : (
                    this.$cache.cont.append(
                        '<span class="irs-bar"></span><span class="irs-shadow shadow-from"></span><span' +
                        ' class="irs-shadow shadow-to"></span><span class="irs-handle from"><i></i><i><' +
                        '/i><i></i></span><span class="irs-handle to"><i></i><i></i><i></i></span>'
                    ),
                    this.$cache.bar = this.$cache.cont.find(".irs-bar"),
        ...
        appendDisableMask: function () {
            this
                .$cache
                .cont
                .append('<span class="irs-disable-mask"></span>'),
            this
                .$cache
                .cont
                .addClass("irs-disabled")
        },
        removeDisableMask: function () {
            this
                .$cache
                .cont
                .remove(".irs-disable-mask"),
            this
                .$cache
                .cont
                .removeClass("irs-disabled")
        },
        remove: function () {
            this
                .$cache
            ...
            this
                .$cache
                .win
                .off("touchend.irs_" + this.plugin_count),
            this
                .$cache
                .win
        ...
        bindEvents: function () {
            this.no_diapason || (
                ...
                this.options.keyboard && this.$cache.line.on(
        ...
        pointerFocus: function (t) {
            var i,
                s;
            this.target || (i = (
                s = "single" === this.options.type
                    ? this.$cache.single
                    : this.$cache.from
            ).offset().left, i += s.width() / 2 - 1, this.pointerClick("single", {
        ...
        pointerMove: function (t) {
            if (this.dragging) {
                var i = t.pageX || t.originalEvent.touches && t
                    .originalEvent
                    .touches[0]
                    .pageX;
        ...
        pointerUp: function (t) {
            this.current_plugin === this.plugin_count && this.is_active && (
                this.is_active = !1,
        ...
        pointerDown: function (t, i) {
            i.preventDefault();
            var s = i.pageX || i.originalEvent.touches && i
                .originalEvent
                .touches[0]
                .pageX;
            2 !== i.button && (
            ...
            if (this.options) {
                ...
                if (this.options.values.length) 
                    this
                        .$cache
                        .min
                        .html(this.decorate(this.options.p_values[this.options.min])),
                    this
                        .$cache
                        .max
                        .html(this.decorate(this.options.p_values[this.options.max]));
                else {
                    ...
                    this
                        .$cache
                        .min
                        .html(this.decorate(t, this.options.min)),
                    this
                        .$cache
                        .max
                        .html(this.decorate(i, this.options.max))
                }
                this.labels.w_min = this
                    .$cache
                    .min
                    .outerWidth(!1),
                this.labels.w_max = this
                    .$cache
                    .max
                    .outerWidth(!1)
            }
        ...
        calc: function (t) {
            if (this.options && (this.calc_count++, (10 === this.calc_count || t) && (
                this.calc_count = 0,
        ...
        calcLabels: function () {
            this.coords.w_rs && !this.options.hide_from_to && (
                "single" === this.options.type
                    ? (
        ...
        drawHandles: function () {
            ...
            this.coords.w_rs && (
                ...
                this.coords.w_rs && (this.dragging || this.force_redraw || this.is_key) && (
                    (this.old_from !== this.result.from || this.old_to !== this.result.to || this.force_redraw || this.is_key) && (
                        ...
                        this.writeToInput(),
                        this.old_from === this.result.from && this.old_to === this.result.to || this.is_start || (
                    ...
                    if ("single" === this.options.type) 
                        ...
                        this.labels.p_from_left + this.labels.p_from_fake >= this.labels.p_to_left
                            ? (
                                ...
                                l = this.result.from === this.result.to
                                    ? (
                                        "from" === this.target
        ...
        drawShadow: function () {
            ...
            "single" === e.type
                ...
                : (
                    ...
                    e.to_shadow && (a || c)
                        ? (
                            s = this.convertToPercent(
                                a
                                    ? e.to_min
                                    : e.min
                            ),
                            o = this.convertToPercent(
                                c
                                    ? e.to_max
                                    : e.max
                            ) - s,
        ...
        callOnChange: function () {
            this.writeToInput(),
            this.options.onChange && "function" == typeof this.options.onChange && (
                this.options.scope
        ...
        callOnFinish: function () {
            this.writeToInput(),
            this.options.onFinish && "function" == typeof this.options.onFinish && (
                this.options.scope
        ...
        validate: function () {
            ...
            s.min_interval && s.min_interval > s.max - s.min && (
            ...
            if (this.options.grid) {
                ...
                for (
                    ...
                    for (
                        ...
                        _ += '<span class="irs-grid-pol small" style="left: ' + this.toFixed(c - e * i) + '%' +
                                '"></span>';
                    _ += '<span class="irs-grid-pol" style="left: ' + c + '%"></span>',
                    h = this.convertToValue(c),
                    _ += '<span class="irs-grid-text js-grid-text-' + t + '" style="left: ' + c +
                            '%">' + (
                        h = r.values.length
                            ? r.p_values[h]
                            : this._prettify(h)
        ...
        calcGridLabels: function () {
            ...
            for (t = 0; t < e; t++) 
                ...
                this
                    .coords
                    .big_p[t] = this.toFixed(this.coords.big_w[t] / this.coords.w_rs * 100),
                this
                    .coords
                    .big_x[t] = this.toFixed(this.coords.big_p[t] / 2),
                s[t] = this.toFixed(this.coords.big[t] - this.coords.big_x[t]),
                o[t] = this.toFixed(s[t] + this.coords.big_p[t]);
            for (
                this.options.force_edges && (
                    s[0] < -this.coords.grid_gap && (s[0] = -this.coords.grid_gap, o[0] = this.toFixed(
                        s[0] + this.coords.big_p[0]
                ...
                this
                    .coords
                    .big_x[t] !== Number.POSITIVE_INFINITY && (
    ...
    a.fn.ionRangeSlider = function (t) {
        return this.each(function () {
            a.data(this, "ionRangeSlider") || a.data(
                this,
                "ionRangeSlider",
                new h(this, t, o++)
            )
