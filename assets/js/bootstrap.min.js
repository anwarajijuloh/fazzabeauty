            ...
            for (var i in n) 
                if (Object.prototype.hasOwnProperty.call(n, i)) {
                    ...
                    if (!new RegExp(o).test(r)) 
                        throw new Error(
                            t.toUpperCase() + ': Option "' + i + '" provided type "' + r + '" but expected ' +
                            'type "' + o + '".'
                        )
                }
            var a
    ...
    var m = "carousel",
        ...
        E = function () {
            ...
            n.nextWhenVisible = function () {
                !document.hidden && e(this._element).is(":visible") && "hidden" !== e(
                    this._element
            ...
            n._addEventListeners = function () {
                var t = this;
                this._config.keyboard && e(this._element).on(
                    "keydown.bs.carousel",
                    (function (e) {
                        return t._keydown(e)
                    })
        ...
        D = function () {
            ...
            n.show = function () {
                ...
                if (!this._isTransitioning && !e(this._element).hasClass("show") && (
                    this._parent && 0 === (n = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter((function (t) {
                    ...
                    if (e(this._element).trigger(s), !s.isDefaultPrevented()) {
                        ...
                        this
                            ._element
                            .style[r] = 0,
                        this._triggerArray.length && e(this._triggerArray)
                    ...
                    if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
                        ...
                        if (o > 0) 
                            for (var s = 0; s < o; s++) {
                                ...
                                if (null !== a) 
                                    e([].slice.call(document.querySelectorAll(a))).hasClass("show") || e(r)
                                        .addClass(
                                            "collapsed"
                                        )
            ...
            i.show = function (i) {
                if (
                    ...
                    if (e(r).trigger(s), !s.isDefaultPrevented()) {
                        ...
                        "ontouchstart" in document.documentElement && 0 === e(r)
                            .closest(".navbar-nav")
                ...
                return this.each((function () {
                    ...
                    if (i || (i = new t(
                        ...
                        "object" == typeof n
                            ? n
                            : null
                    ), e(this).data("bs.dropdown", i)), "string" == typeof n) {
                ...
                if (!(
                    ...
                    if (o || 27 !== n.which) {
                        if (
                            ...
                            return 27 === n.which && e(i.querySelector('[data-toggle="dropdown"]')).trigger(
                                "focus"
                            ),
                ...
                a.forEach((function (t) {
                    (function (t, e) {
                        var n = t
                            ...
                            .toLowerCase();
                        if (-1 !== e.indexOf(n)) 
                            return -1 === q.indexOf(n) || Boolean(
                                t.nodeValue.match(Q) || t.nodeValue.match(B)
                            );
        ...
        $ = function () {
            ...
            i.show = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    e.contains(this.element.ownerDocument.documentElement, this.tip) || e(r).appendTo(
                        u
                    ),
                    e(this.element).trigger(this.constructor.Event.INSERTED),
                    this._popper = new n(this.element, r, this._getPopperConfig(h)),
                    e(r).addClass("show"),
                    "ontouchstart" in document.documentElement && e(document.body)
                        .children()
                        .on("mouseover", null, e.noop);
                    var d = function () {
            ...
            i.hide = function (t) {
                var n = this,
                    ...
                    s = function () {
                        "show" !== n._hoverState && i.parentNode && i
                            .parentNode
                            .removeChild(i),
                        n._cleanTipClass(),
                        n
        ...
        ht = function () {
            ...
            return n.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass("active") || e(this._element).hasClass("disabled"))) {
                    ...
                    if (o) {
                        var r = "UL" === o.nodeName || "OL" === o.nodeName
                            ? "> li > .active"
                            : ".active";
            ...
            n._transitionComplete = function (t, n, i) {
                ...
                if (
                    ...
                    if (s) {
                        var r = []
                            .slice
                            .call(s.querySelectorAll(".dropdown-toggle"));
                        e(r).addClass("active")
                    }
